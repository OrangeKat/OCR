...
void event_loop(SDL_Renderer* renderer,SDL_Texture* texture, SDL_Texture* white,SDL_Window* window, double angle)
{
...
event_loop(renderer, texture,white_texture ,window, angle);
